...
| **[`blog-template`](https://github.com/7th-heaven-co/blog-template-astro-cloudflare)** | Minimal scaffold of the 7th‑Heaven blog — drop‑in starter with opinionated configs and ready‑to‑deploy CI. | Astro 5, React 18, MDX, SCSS, GitHub Actions, Wrangler |
